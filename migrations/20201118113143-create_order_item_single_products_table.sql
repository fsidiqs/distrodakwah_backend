-- +migrate Up
CREATE TABLE IF NOT EXISTS `order_item_single_products`(
    ...
    CONSTRAINT order_item_single_products_order_id FOREIGN KEY(order_id) references orders(id),
...
-- +migrate Down
DROP TABLE `order_item_single_products`;