-- +migrate Up
CREATE TABLE IF NOT EXISTS `order_items_variant_products`(
    ...
    CONSTRAINT order_items_variant_products_order_id FOREIGN KEY(order_id) references orders(id),
...
-- +migrate Down
DROP TABLE `order_items_variant_products`;